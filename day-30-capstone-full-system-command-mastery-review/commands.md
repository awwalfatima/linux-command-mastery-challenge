...
2.	nano day30_healthcheck2.sh
	echo "process: "&ps aux
	echo "services: "&systemctl status
	echo "system logs: "&journalctl -n 20
	chmod +x day30_healthcheck2.sh
	./day30_healthcheck2.sh
3.	ssh -i C:\Users\pc\Downloads\my-linux-challenge-keypair.pem ec2-user@44.220.193.98
	hostname
	whoami
4.	ls -l ~/my-linux-challenge-keypair.pem
	...
	./day30_healthcheck.sh
5.	chmod 744 day30_healthcheck.sh
	ls -l day30_healthcheck.sh
	whoami
...
8.	find /home/ec2-user -type f -name "*.log" -mtime +7 -print
9.	last -n 10
	who
	history | tail -n 20
